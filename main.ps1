...
echo "`"$(${ResoniteLocation} | Split-Path | Split-Path | Split-Path)\steam.exe`" -applaunch 2519830 -LoadAssembly Libraries\ResoniteModLoader.dll" |  Out-File -FilePath Resonite.bat -Encoding utf8
